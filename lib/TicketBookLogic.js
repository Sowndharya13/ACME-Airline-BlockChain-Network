       ...
       res = res.split("\"")[0];
               ...
               return getAssetRegistry('org.acme.airline.aircraft.Aircraft')
                 ...
                 if(specificAircraft.FIRSTCLASS < ticketData.numberOfSeatsToReserve ){
                   throw new Error(" The given number of "+ ticketData.numberOfSeatsToReserve +"tickets are not available in : " + ticketData.seatClass );

                 }

                 specificAircraft.FIRSTCLASS =  specificAircraft.seatClass - ticketData.numberOfSeatsToReserve;
